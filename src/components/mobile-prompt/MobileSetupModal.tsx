  ...
  const steps = [
    {
      ...
      body: 'Install Tailscale on the machine running Petasos, then sign in.',
    ...
    },
    {
      ...
      body: 'Petasos can talk to any OpenAI-compatible backend on mobile too. Make sure both the workspace and backend stay reachable over Tailscale or your local network.',
    ...
    {
      title: 'Open Petasos on your phone',
      body:
