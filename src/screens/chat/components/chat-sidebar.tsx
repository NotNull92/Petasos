        ...
        <AnimatePresence initial={false}>
          {!isVisuallyCollapsed ? (
            ...
            >
              ...
              >
                <img src="/petasos-avatar.webp" alt="Hermes" className="size-6 rounded-lg" />
                <span className="text-sm font-semibold tracking-tight" style={{ color: 'var(--theme-text)' }}>Petasos</span>
              </Link>
            </motion.div>
          ) : null}
        </AnimatePresence>
